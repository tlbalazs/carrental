BACKUP LOG [CarRental] TO  DISK = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\Backup\CarRentalLogBackup.bak' WITH  RETAINDAYS = 14, NOFORMAT, NOINIT,  NAME = N'CarRental-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10, CHECKSUM
GO
